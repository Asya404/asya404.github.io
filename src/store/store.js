...
const store = createStore({
	state() {
		return {
			projects: [
				{
					imageUrl: "../../public/assets/growint.png",
				...
				{
					imageUrl: "../../public/assets/viva-cruises.png",
				...
				{
					imageUrl: "../../public/assets/orbico.png",
				...
				{
					imageUrl: "../../public/assets/expense-tracker.png",
				...
				{
					imageUrl: "../../public/assets/letmed.png",
				...
				{
					imageUrl: "../../public/assets/find-a-therapist.png",
